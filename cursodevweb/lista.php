...
<body>
    <div class="wrapper-table">
        <h1>Empresas Leonard's</h1>
        <div class="menu">
            <a href="inicio.php">Cadastro</a>
            <a href="lista.php" class="destaque">Lista</a>
        ...
        <table>
            ...
            <?php while ($linha = $lista->fetch(PDO::FETCH_ASSOC)) { ?>
                <tr>
                    ...
                    <td><?php echo $linha['esc'] ?></td>
                    <td><?php echo $linha['form'] ?></td>


                    
                    <td class="actions">
                        <button class="update">
                                <a href="inicio.php?id=<?php echo $linha['id'] ?>" >
                                Editar
                                </a>
                        </button>
